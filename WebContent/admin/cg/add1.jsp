...
<table class="table table-bordered"> 
     ...
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">申请专利级别：</td>
     <td><select name="lb">
    ...
    <option value="外观设计专利">外观设计专利</option> 
     ...
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">专利名称：</td>
     <td><input type="text" name="mc" class="span4" value="<%=mc %>" required/></td> 
     </tr> 
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">专利发明人：</td>
     <td><input type="text" name="fzr" class="span4" value="<%=fzr %>" required/></td> 
     </tr>  
     
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">专利授权年份：</td>
     <td><input type="text" name="xk" class="span4" value="<%=xk %>" required/></td>  
     </tr>
     
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">专利成果说明：</td>

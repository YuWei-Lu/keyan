...
<table class="table table-bordered"> 
     ...
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">申请科技获奖类别：</td>
     <td><select name="lb">
    <%if(method.equals("upcg")){ %><option value="<%=lb%>"><%=lb%></option> <%} %>  
    <option value="国家级科技获奖">国家级科技获奖</option> 
    <option value="省级科技获奖">省级科技获奖</option>
    <option value="市级科技获奖">市级科技获奖</option>
    <option value="校级科技获奖">校级科技获奖</option> 
    </select></td> 
     </tr>
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">科技获奖项目名称：</td>
     <td><input type="text" name="mc" class="span4" value="<%=mc %>" required/></td> 
     </tr> 
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">科技获奖人：</td>
     <td><input type="text" name="fzr" class="span4" value="<%=fzr %>" required/></td> 
     </tr>  
     
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">科技获奖日期：</td>
     <td><input type="text" name="xk" class="span4" value="<%=xk %>" required/></td>  
     </tr>
     
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">科技获奖说明：</td>

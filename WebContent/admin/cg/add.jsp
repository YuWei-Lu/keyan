...
<table class="table table-bordered"> 
     ...
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">申请论文级别：</td>
     <td><select name="lb">
    <%if(method.equals("upcg")){ %><option value="<%=lb%>"><%=lb%></option> <%} %>  
    <option value="普刊论文">普刊论文</option> 
    <option value="核心论文">核心论文</option> 
    <option value="EI论文">EI论文</option> 
    <option value="CSSCI论文">CSSCI论文</option>
    <option value="SCI论文">SCI论文</option> 
    </select></td> 
     </tr>
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">论文名称：</td>
     <td><input type="text" name="mc" class="span4" value="<%=mc %>" required/></td> 
     </tr> 
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">论文作者：</td>
     <td><input type="text" name="fzr" class="span4" value="<%=fzr %>" required/></td> 
     </tr>  
     
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">发表年份：</td>
     <td><input type="text" name="xk" class="span4" value="<%=xk %>" required/></td>  
     </tr>
     
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">论文成果说明：</td>
     <td><input type="text" name="bz" class="span2" value="<%=bz %>" required/></td> 
     </tr> 
     <%if(method.equals("upcg")){ %>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">上传证明材料汇总附件：</td>
     <td><input type=file name="pic" class="span4"  /> （证明材料需汇总在一个word文件上传） </td> 
     </tr> 
     <%}else{ %>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">上传证明材料汇总附件：</td>
     <td><input type=file name="pic" class="span4" required/>（证明材料需汇总在一个word文件上传）</td> 
     </tr> 
     <%} %>  
     <tr>

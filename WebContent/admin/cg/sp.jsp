...
String message = (String)request.getAttribute("message");
	...
	if(admin==null){
		...
		String sh = cb.getString("select sh from cg where id='"+id+"'"); 
		String yj = cb.getString("select yj from cg where id='"+id+"'");
%>
<body>
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">审批成果：</td>
     <td><select name="sh">

...
<table class="table table-bordered"> 
    ...
    <option value="著作">著作</option> 
     ...
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">教材或著作名称：</td>
     <td><input type="text" name="mc" class="span4" value="<%=mc %>" required/></td> 
     </tr> 
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">教材或著作作者：</td>
     <td><input type="text" name="fzr" class="span4" value="<%=fzr %>" required/></td> 
     </tr>  
     
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">教材或著作出版日期：</td>
     <td><input type="text" name="xk" class="span4" value="<%=xk %>" required/></td>  
     </tr>
     
     <tr> 
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">教材或著作出版社：</td>

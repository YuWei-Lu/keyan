...
String message = (String)request.getAttribute("message");
	...
	if(admin==null){
		...
		String zj = cb.getString("select zj from xm where id='"+id+"'");  
%>
<body>
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">中检情况：</td>
     <td><textarea name="zj" cols="100" class="span4" rows="5" required><%=zj%></textarea></td> 
     </tr>  
     <tr>

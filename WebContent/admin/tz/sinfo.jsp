...
<%	String word=Common.toChineseAndTrim(request.getParameter("word")); 
	...
	int cou = cb.getMessageCount("select count(*) from tz where mc like '%"+word+"%' ");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from tz where mc like '%"+word+"%' order by id desc",6);
...
%>       
       <tr align="center">
         ...
         <td nowrap="nowrap">
         <a href="<%=basePath%>admin/tz/add.jsp?method=uptz&id=<%=pagelist2.get(0).toString()%>">修改</a> 

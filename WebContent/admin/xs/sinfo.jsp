...
<table class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td><strong>职称信息</strong></td>
         <td><strong>单位信息</strong></td>
...
<%String word=Common.toChineseAndTrim(request.getParameter("word")); 
	...
	int cou = cb.getMessageCount("select count(*) from admin where username like '%"+word+"%' or realname like '%"+word+"%' and sf ='科研人员'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from admin where username like '%"+word+"%' or realname like '%"+word+"%'  and sf ='科研人员' order by id desc",10);

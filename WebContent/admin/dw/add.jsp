...
String message = (String)request.getAttribute("message");
	...
	if(admin==null){
		...
		if(method.equals("updw")){
			id=request.getParameter("id");
			List jlist = cb.get1Com("select * from dw where id='"+id+"'",3);
...
<table class="table table-bordered"> 
     ...
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">单位名称：</td>
     <td><input type="text" name="mc" class="span4" value="<%=mc %>" required/></td> 
     </tr>  
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">单位说明：</td>

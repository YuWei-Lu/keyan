...
<div id="my_menu" class="sdmenu">
	...
	<div class="collapsed">
		...
		<a href="<%=basePath %>admin/cg/add.jsp?method=addcg" target="MainFrame">在线申报论文成果</a>
		<a href="<%=basePath %>admin/cg/add1.jsp?method=addcg" target="MainFrame">在线申报专利成果</a>
		<a href="<%=basePath %>admin/cg/add2.jsp?method=addcg" target="MainFrame">在线申报教材与著作成果</a> 
		<a href="<%=basePath %>admin/cg/add3.jsp?method=addcg" target="MainFrame">在线申报科技获奖成果</a>  
